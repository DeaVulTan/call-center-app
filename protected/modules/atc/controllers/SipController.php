...
//				'users'=>array('*'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SipDevices']))
		{
			...
			$allow = array();
			if(is_array($_POST['SipDevices']['allow_audio'])) {
				$allow = array_merge($_POST['SipDevices']['allow_audio'], $allow);
			}
			if(is_array($_POST['SipDevices']['allow_video'])) {
				$allow = array_merge($_POST['SipDevices']['allow_video'], $allow);
			}
