...
/**
 * Модель для таблицы "queue_member_table".
 *
 * Доступные колонки в таблице 'queue_member_table':
 ...
 */
class QueueMemberTable extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record класс.
	 * @return QueueMemberTable статический класс модели
	 */
